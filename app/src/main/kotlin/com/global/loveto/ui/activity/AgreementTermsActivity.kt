...
import com.global.loveto.ui.fragment.AgreementTermsFragment

class AgreementTermsActivity : BaseActivityFragment() {
    ...
    companion object {
        ...
        fun callingIntent(context: Context?, farmer: Farmer): Intent {
            val intent = Intent(context, AgreementTermsActivity::class.java)
            val bundle = Bundle()
    ...
    override fun fragment() = AgreementTermsFragment.newInstance(farmer)
}