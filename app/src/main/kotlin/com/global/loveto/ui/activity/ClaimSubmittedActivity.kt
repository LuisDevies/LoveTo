...
import com.global.loveto.ui.fragment.ClaimSubmittedFragment

class ClaimSubmittedActivity : BaseActivityFragment() {
    ...
    companion object {
        ...
        fun callingIntent(context: Context?, farmer : Farmer, synced : Boolean): Intent {
            val intent = Intent(context, ClaimSubmittedActivity::class.java)
            val bundle = Bundle()
    ...
    override fun fragment() = ClaimSubmittedFragment.newInstance(farmer,synced)
