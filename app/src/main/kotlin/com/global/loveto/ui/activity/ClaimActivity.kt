...
import com.global.loveto.ui.fragment.ClaimFragment

class ClaimActivity : BaseActivityFragment() {
    ...
    companion object {
        ...
        fun callingIntent(context: Context?, farmer: Farmer): Intent {
            val intent = Intent(context, ClaimActivity::class.java)
            val bundle = Bundle()
    ...
    override fun fragment() = ClaimFragment.newInstance(farmer)
