...
class ClaimSubmittedFragment : BaseFragment() {
    ...
    companion object {
        ...
        fun newInstance(farmer: Farmer, synced: Boolean): ClaimSubmittedFragment {
            val fragment = ClaimSubmittedFragment()
    ...
    override fun layoutId() = R.layout.fragment_claim_submitted_fargment
